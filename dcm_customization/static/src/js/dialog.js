odoo.define('global_search_cr.Dialog', function (require) {
"use strict";
...
var Dialog = Widget.extend({
    xmlDependencies: ['/global_search_cr/static/src/xml/dialog.xml'],
    ...
    willStart: function () {
        ...
        return this._super.apply(this, arguments).then(function () {
            ...
            self.$modal = $(QWeb.render('GlobalSearchDialog', {
                title: self.title,
